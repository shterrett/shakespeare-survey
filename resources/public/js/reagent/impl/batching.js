...
{var C_5471 = (a[i]);if(cljs.core.truth_(C_5471.cljsIsDirty))
{C_5471.forceUpdate();
} else
{}
{
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_5473 = C.cljsRatom;if(!((ratom_5473 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_5473);
} else
{}
