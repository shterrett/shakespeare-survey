...
(defn init
  ...
  (timbre/set-config!
    ...
    {:path "shakespeare_survey.log" :max-size (* 512 1024) :backlog 10})

  (if (env :dev) (parser/cache-off!))
  ;;start the expired session cleanup job
  (cronj/start! session-manager/cleanup-job)
  (timbre/info "shakespeare-survey started successfully"))

(defn destroy
  "destroy will be called when your application
   shuts down, put any clean up code here"
  []
  (timbre/info "shakespeare-survey is shutting down...")
